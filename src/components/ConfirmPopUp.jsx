...
export function ConfirmPopUpProvider({ children }) {
    ...
    return (
        <>
            <div className={popUpData.enable ? "visible" : "hidden"}>
                ...
                <div
                    className={
                        ...
                        " transition-all fixed top-1/2 -translate-x-1/2  -translate-y-1/2 z-40 left-1/2 bg-white min-w-[14em]  p-3 rounded-xl m-auto opacity-100 w-min"
                    }
                >
            ...
            <ConfirmPopUpContext.Provider value={popUp}>
                {children}
