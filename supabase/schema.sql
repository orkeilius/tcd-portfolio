...
ALTER TABLE ONLY "public"."comment"
    ADD CONSTRAINT "comment_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."userInfo"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."portfolio"
    ADD CONSTRAINT "portfolio_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "public"."userInfo"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."project_user"
    ADD CONSTRAINT "project_user_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."userInfo"("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."userInfo"
    ADD CONSTRAINT "userInfo_id_fkey" FOREIGN KEY ("id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."userInfo"
    ADD CONSTRAINT "userInfo_role_fkey" FOREIGN KEY ("role") REFERENCES "public"."role"("id") ON DELETE RESTRICT;
...
CREATE POLICY "Enable read access for user in same project" ON "public"."userInfo" FOR SELECT USING (((0 <> ( SELECT "count"(*) AS "count"
   FROM "public"."project_user"
  WHERE (("project_user"."user_id" = "auth"."uid"()) AND ("project_user"."project_id" IN ( SELECT "project_user_1"."project_id"
          ...
          WHERE ("project_user_1"."user_id" = "userInfo"."id")))))) OR ("auth"."uid"() = "id")));
